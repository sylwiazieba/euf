...
def load_seeding_log(path: Path) -> pd.DataFrame:
    ...
    null_like = {"nan", "none", "null", "na", "n/a", "n a"}
    data = data[
...
def build_sheets(crop_varieties: pd.DataFrame, form_title: str, form_id: str):
    ...
    choices_df = pd.DataFrame(crop_rows + variety_rows + unit_rows)[
    ...
    survey_df = pd.DataFrame(
        [
            ...
            {"type": "select_one crop_type", "name": "crop", "label": "Crop Type", "appearance": "minimal", "relevant": "", "choice_filter": "", "required": "yes", "default": ""},
            {"type": "select_one variety", "name": "variety", "label": "Variety", "appearance": "minimal", "relevant": "", "choice_filter": "crop=${crop}", "required": "yes", "default": ""},
